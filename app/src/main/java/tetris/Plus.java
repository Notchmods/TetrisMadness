...
public class Plus extends Block{
    ...
    private Location[][] relativeHighlightLocations = new Location[5][1];
    private Location[][] absoluteHighlightLocations = new Location[5][1];
    ...
    public Plus(Tetris tetris) {
        ...
        //Blocks location
        relativeHighlightLocations[0][0]=new Location(1,0);
        relativeHighlightLocations[1][0]=new Location(0,1);
        relativeHighlightLocations[2][0]=new Location(1,1);
        relativeHighlightLocations[3][0]=new Location(1,2);
        relativeHighlightLocations[4][0]=new Location(2,1);
