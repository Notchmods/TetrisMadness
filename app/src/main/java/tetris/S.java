...
public class S extends Block {
    ...
    private final BlockPieces blockPiece = BlockPieces.S;
    ...
    S(Tetris tetris) {
        ...
        // rotationId 0
        rotationLocation[0][0] = new Location(new Location(2, 0));
        ...
        rotationLocation[2][1] = new Location(new Location(-1, 0));
        ...
        rotationLocation[2][2] = new Location(new Location(0, -1));
        ...
        rotationLocation[2][3] = new Location(new Location(1, 0));
