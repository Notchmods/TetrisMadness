...
public class Cross extends Block {
    ...
    public Cross(Tetris tetris) {
        super(tetris);

        //Blocks location
        relativeHighlightLocations[0][0]=new Location(0,0);
        relativeHighlightLocations[1][0]=new Location(0,2);
        relativeHighlightLocations[2][0]=new Location(1,1);
        relativeHighlightLocations[3][0]=new Location(2,0);
        relativeHighlightLocations[4][0]=new Location(2,2);
