...
public class I extends Block {
    ...
    private Location[][] relativeHighlightLocations = new Location[4][1];
    private Location[][] absoluteHighlightLocations = new Location[4][1];
    I(Tetris tetris) {
        super(tetris);
        // rotationId 0
        ...
        rotationLocation[3][0] = new Location(new Location(3, 0));
        // rotationId 1
        rotationLocation[0][1] = new Location(new Location(0, 0));
        rotationLocation[1][1] = new Location(new Location(0, 1));
        rotationLocation[2][1] = new Location(new Location(0, 2));
        rotationLocation[3][1] = new Location(new Location(0, 3));
        // rotationId 2
        rotationLocation[0][2] = new Location(new Location(0, 0));
        rotationLocation[1][2] = new Location(new Location(1, 0));
        rotationLocation[2][2] = new Location(new Location(2, 0));
        rotationLocation[3][2] = new Location(new Location(3, 0));
        // rotationId 3
        rotationLocation[0][3] = new Location(new Location(0, 0));
        rotationLocation[1][3] = new Location(new Location(0, 1));
        rotationLocation[2][3] = new Location(new Location(0, 2));
        rotationLocation[3][3] = new Location(new Location(0, 3));
        ...
        relativeHighlightLocations[3][0] = new Location(new Location(3, 0));
    }
